...
function findWasmBinary() {
  return locateFile('gemu-chip8.wasm');
}
...
var ASM_CONSTS = {
  149404: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 149619: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 149766: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
...
var _gemu_web_monitor_input = Module['_gemu_web_monitor_input'] = makeInvalidEarlyAccess('_gemu_web_monitor_input');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['gemu_web_monitor_input'] != 'undefined', 'missing Wasm export: gemu_web_monitor_input');
  ...
  _gemu_web_monitor_input = Module['_gemu_web_monitor_input'] = createExportWrapper('gemu_web_monitor_input', 1);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createGemu;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createGemu;
